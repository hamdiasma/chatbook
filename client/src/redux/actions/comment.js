...
export const updateCommentAction = ({ comment, content, post, auth }) => async dispatch => {
...
export const unLikeCommentAction = ({ comment, post, auth }) => async dispatch => {
  const newComment = {
    ...comment,
...
export const deleteCommentAction = ({ post, auth, comment, socket }) => async dispatch => {
